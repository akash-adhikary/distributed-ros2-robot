...
print('=== LIVE PRODUCTION IMU DATA FROM BNO086 ===')
for i in range(12):
    ...
    print(f'Sample #{i+1:02d} | Frames={frames} | Packets={cnt} | Roll={roll}° Pitch={pitch}° Yaw={yaw}° | Quat=({qr},{qi},{qj},{qk}) | Acc=({ax},{ay},{az}) | Gyro=({gx},{gy},{gz})')
    time.sleep(0.25)
s.close()
"
""")
child.expect([r'=== LIVE PRODUCTION IMU DATA FROM BNO086 ==='], timeout=15)
