...
class BNO08xPublisher(Node):
    def __init__(self):
        ...
        self.sock = None
        self.connect_socket()
        self.timer = self.create_timer(0.01, self.timer_callback) # 100 Hz real-time
        self.last_quat = [1.0, 0.0, 0.0, 0.0]
        self.get_logger().info("High-Speed 100Hz IMU Publisher initialized.")
    ...
    def timer_callback(self):
        ...
        qr, qi, qj, qk, lax, lay, laz, gx, gy, gz = parts
        ...
        # Linear acceleration in m/s^2 (gravity subtracted)
